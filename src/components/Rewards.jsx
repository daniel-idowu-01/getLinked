...
const Rewards = () => {
  ...
  return (
    <section>
        ...
        <div className='relative text-white text-center md:text-left md:w-1/2 md:left-1/2 pt-20 pb-0 '>
        ...
        {/* div for the images */}
        <div className='flex flex-col md:flex-row gap-3 md:gap-0 justify-evenly items-center text-white mt-10 md:mt-0'>
            <article className='relative flex justify-center items-center md:w-[40%]'>
                <img src={purpleBg} alt="" className='absolute md:left-1/4 rounded-[100%] w-11/12 filter brightness-50' />
            ...
            <article className='p-10 md:p-20 '>
                <div className='flex items-center w-1/2'>
                    ...
                    <img src={position1} className='' alt="" />
