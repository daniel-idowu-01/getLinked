...
const Partners = () => {
    ...
    const gridItem = 'border-2 border-secondary-color h-full w-full p-5 px-10'
  ...
  return (
    <section>
        ...
        <article className='w-1/2 mx-auto grid grid-cols-3 gap-5 p-20 place-items-center border border-secondary-color'>
